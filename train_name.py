...
def main(args):
    ...
    for _ in range(num_augmented_copies):
        augmented_datasets.append(UniqloDataset(csv_file='datasets\csv_for_name\data_name.csv', 
    ...
    valid_set = UniqloDataset(csv_file='datasets\csv_for_name\data_name_valid.csv', 
                              root_dir='datasets/images',
                              label_column='index',
    ...
    last_checkpoint_filename = f'name_model_lr_{args.lr_ft}_{args.lr_new}_{time_str}.pt'
    ...
    if args.log:
        wandb.init(project="Uniqlo price prediction", name = f'Uniqlo_name_lr_{args.lr_ft}_{args.lr_new}')
